...
class Cerita1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pengecat Langit Malam'),
      ),
      body: Center(
        child: Column(
